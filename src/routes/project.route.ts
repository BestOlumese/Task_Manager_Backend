...
import {
    ...
    getAllProjectsInController,
    getProjectAnalyticsController,
    getProjectByIdAndWorkspaceIdController, updateProjectController
...
projectRoutes.get("/workspace/:workspaceId/all", getAllProjectsInController)
